  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<p class="pt-8 text-sm"><span class="text-pink-600">Would love to develop and autoscaling your amazing app.</span><br><b>Design</b> with Tailwind,Bootstrap, or Vanila CSS<br><b>FrontEnd</b> Laravel,ReactJs, NodeJs, ReactNative Expo(Android)<br><b>Backend</b> Docker, Kubernetes, Ansible, Terraform, <br><b>Implementing CI/CD</b> with Github Action<br><b>Databases</b> mySql, MongoDb, redis.</p>
